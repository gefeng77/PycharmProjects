...
class Requirement(object):
    ...
    # TODO: Can we learning_test whether something is contained within a requirement?
    #       If so how do we do that? Do we need to learning_test against the _name_ of
